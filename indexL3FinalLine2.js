...
// Reihe 2
    ...
    console.log
    (gradient.rainbow("OO  "), gradient.rainbow("║════ 6═║ "), gradient.rainbow("║════ 7═║ "), gradient.rainbow("║════ 8═║ "), gradient.rainbow("║════ 9═║ "), gradient.rainbow("║════10═║ "), gradient.rainbow("║════11═║ "), gradient.rainbow("  OO" ));
  ...
  console.log
  (gradient.rainbow("OO  "), gradient.rainbow("║════12═║ "), gradient.rainbow("║════13═║ "), gradient.rainbow("║════14═║ "), gradient.rainbow("║════15═║ "), gradient.rainbow("║════16═║ "), gradient.rainbow("║════17═║ "), gradient.rainbow("  OO" ));
